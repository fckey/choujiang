...
CREATE TABLE `cj_draw`  (
  `draw_id` int NOT NULL AUTO_INCREMENT COMMENT '唯一标识某次抽签',
...
CREATE TABLE `cj_draw_record`  (
  `record_id` int NOT NULL AUTO_INCREMENT COMMENT '唯一标识某次抽签活动',
  ...
  `record_status` int NULL DEFAULT NULL COMMENT '1表示改签是有效签 ',
...
CREATE TABLE `cj_organization`  (
  `org_code` int NOT NULL AUTO_INCREMENT COMMENT '主键，单位代码，键表示唯一',
  ...
  `org_joined` int NULL DEFAULT 0 COMMENT '0 代表没有参加， 1 代表参加',
...
-- ----------------------------
INSERT INTO `cj_organization` VALUES (1, '南昌市农科院园艺研究所', NULL, NULL);
INSERT INTO `cj_organization` VALUES (2, '南昌县科大新技术研究所', 12, 1);
INSERT INTO `cj_organization` VALUES (3, '广播电视事业单位', 12, 0);
INSERT INTO `cj_organization` VALUES (5, '艺术创作事业单位', 0, 0);
INSERT INTO `cj_organization` VALUES (6, '图书文献事业单位', 0, 0);
INSERT INTO `cj_organization` VALUES (7, '文物事业单位', 0, 1);
INSERT INTO `cj_organization` VALUES (8, '群众文化事业单位', 0, 0);
...
-- Records of cj_user
-- ----------------------------
INSERT INTO `cj_user` VALUES (1, 'fangshaolei', 'ef63227abb102d7a74b06f4fdfee44f8', NULL, 0);
INSERT INTO `cj_user` VALUES (5, 'zhangsan', 'df10ef8509dc176d733d59549e7dbfaf', NULL, 1);
INSERT INTO `cj_user` VALUES (6, 'lisi', 'df10ef8509dc176d733d59549e7dbfaf', NULL, 1);
INSERT INTO `cj_user` VALUES (7, 'fasfsafg', 'df10ef8509dc176d733d59549e7dbfaf', 1, 1);
